...
/**
 * Fork of CMenu to handle &lt;nav&gt; bars.
 */
class CLinkNav extends CWidget
{
	/**
	...
	{
		$mixed = array_merge(isset($item['linkOptions']) ? $item['linkOptions'] : array(), $options);
		if(isset($item['url']))
		{
			$label=$this->linkLabelWrapper===null ? $item['label'] : CHtml::tag($this->linkLabelWrapper, $this->linkLabelWrapperHtmlOptions, $item['label']);
			return CHtml::link($label,$item['url'],$mixed);
		}
		else
			return CHtml::tag('span',$mixed, $item['label']);
	}
