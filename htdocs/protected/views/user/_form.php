...
<fieldset>
    ...
    <div class="input-prepend">
        ...
        <?php echo $form->textField($model,'login',array('maxlength'=>140,'class'=>'span9','placeholder' => Yii::t('User', 'Login'))); ?>
    </div>
	<?php echo $form->error($model,'login', array('class' => 'alert alert-error')); ?>

    <div class="input-prepend">
        <span class="add-on"><i class="icon-lock"></i></span>
	    <?php echo $form->passwordField($model,'password',array('value'=>'','maxlength'=>40,'class'=>'span9','placeholder' => Yii::t('User', 'Password'))); ?>
    </div>
	<?php echo $form->error($model,'password', array('class' => 'alert alert-error')); ?>

    <div class="input-prepend">
        <span class="add-on"><i class="icon-user"></i></span>
	    <?php echo $form->textField($model,'name',array('maxlength'=>255,'class'=>'span9','placeholder' => Yii::t('User', 'Name'))); ?>
	</div>
	<?php echo $form->error($model,'name', array('class' => 'alert alert-error')); ?>

    <div class="input-prepend">
        <span class="add-on"><i class="icon-flag"></i></span>
	    <?php echo $form->textField($model,'role',array('maxlength'=>20,'class'=>'span9','placeholder' => Yii::t('User', 'Role'))); ?>
	</div>
